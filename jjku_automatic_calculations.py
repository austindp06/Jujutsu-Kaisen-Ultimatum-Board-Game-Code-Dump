            ...
            if 0 <= choice < len(available_attacks):
                    ...
                    if self.name == "Jogo":
                        if attack == "Disaster Flames":
                            ...
                            print(f"{self.name} uses Disaster Flames!, "
                                  f"Flames deal {damage} damage, residual flames deal {residual} damage.")
                        elif attack == "Volcano":
                            self.place_volcano()
                            return
                            ...
                            if self.jogo_domain_active:
                                damage += 1
                            print(f"Contact Flame deals {damage} damage! Will continue to deal 1 damage per turn until death.")
                ...
                if attack == "Transfigured Human":
                    ...
                    try:
                        ...
                        self.attack_points_current += 1
                        return
                elif attack == "Idle Transfiguration":
                    try:
                        soul_gain = int(input("How many enemies were killed?"))
                        self.soul_stock = soul_gain
                    except ValueError:
                        ...
                        self.attack_points_current += 1
                        return
                elif attack == "Polymorphic Soul Isomer":
                    try:
                        ...
                        self.attack_points_current += 1
                        return
                elif attack == "Soul Multiplicity: Body Repel":
                    try:
                        self.soul_stock -= 3
                        if self.soul_stock < 0:
                ...
                if attack == "Blood-Dipped Arrows":
                    try:
                        num_arrows = int(input(f"How many arrows to fire for {self.name}? (1–3, 20 CE each, {self.ce} CE available, 0 to cancel): "))
                        if num_arrows == 0:
