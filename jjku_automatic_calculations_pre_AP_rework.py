...
xp_drops: Dict[str, int] = {
    ...
    "Teen Gojo (SG)": 22, "Todo (SG)": 17, "Megumi (SG)": 18, "Last Leg Megumi (SG)": 17,
    "Yuji (SG)": 16, "Inumaki (SG)": 17, "Geto (SG)": 16, "Teen Geto (SG)": 15, "Maki (SG)": 15,
    "Jiro (SG)": 12, "Utahime (SG)": 14, "Naoya (SG)": 17, "Kenjaku (SG)": 25, "Gojo (SG)": 25
}
    ...
    def perform_attack  (self) -> None:
        ...
        #Choso Kamo attacks
                ...
                if attack == "Crimson Blade":
                    ...
                    if damage < secondary:
                        damage, secondary = secondary, damage
                    print(f"Crimson Blade deals {damage} damage!")
                    if secondary >= 4:
                ...
                if attack == "Crimson Blade+":
                    damage = random.randint(1, 6) + random.randint(1, 6)
                    print(f"Crimson Blade deals {damage} damage! Choso may exit the tile for free.")
